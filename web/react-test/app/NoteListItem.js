  ...
  render: function() {
    return (
      <li className='noteListItem mb2'>
        <Link to='speedread' params={{noteId: this.props.id}} className='light-gray ml2'>
        ...
        <Link to='notes' params={{noteId: this.props.id}} className='h5 noteTitle ml2 light-gray light'>
          {this.props.title}
        </Link>
      </li>
    );
